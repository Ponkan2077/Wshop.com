...
<head>
    ...
    <title>ASRock X570 PG VELOCITA AM4 ATX</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/motherboard/mother board 2/How-to-Check-and-Identify-Your-Motherboard-fotor-bg-remover-2024042733738.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/motherboard/mother board 2/How-to-Check-and-Identify-Your-Motherboard-fotor-bg-remover-2024042733738.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
            ...
            <div class="productInfo">
                <h4>ASRock X570 PG VELOCITA AM4 ATX</h4>
