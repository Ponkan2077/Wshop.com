...
<head>
    ...
    <title>NZXT F120 RGB Core</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/fans/fans1/1681530875-f120-rgb-core-fan-angled-upward-left-side-view-white.avif" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/fans/fans1/1681530875-f120-rgb-core-fan-angled-upward-left-side-view-white.avif"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
