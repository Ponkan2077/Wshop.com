...
<head>
    ...
    <title>APC Back-UPS, 1200VA, Tower, 230V</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/upc/ups 2/6478.jpg-fotor-bg-remover-2024042733651.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/upc/ups 2/6478.jpg-fotor-bg-remover-2024042733651.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
            ...
            <div class="productInfo">
                <h4>APC Back-UPS, 1200VA, Tower, 230V</h4>
