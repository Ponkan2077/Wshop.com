...
<head>
    ...
    <title>Adata Premier DDR4 3200 Memory</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/ram/ram 2/adata_16gb_ddr4_3200_pc4-25600_ad4s320016g22-sgn_sodimm-fotor-bg-remover-2024042733010.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/ram/ram 2/adata_16gb_ddr4_3200_pc4-25600_ad4s320016g22-sgn_sodimm-fotor-bg-remover-2024042733010.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
            ...
            <div class="productInfo">
                <h4>Adata Premier DDR4 3200 Memory</h4>
