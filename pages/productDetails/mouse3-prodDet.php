...
<head>
    ...
    <title>SteelSeries Rival 3</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/accesories/mouse/sdaaa_800x-fotor-bg-remover-2024042734115.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/accesories/mouse/sdaaa_800x-fotor-bg-remover-2024042734115.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
