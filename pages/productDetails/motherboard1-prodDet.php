...
<head>
    ...
    <title>MSI B360 Gaming Plus</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/motherboard/mother board 1/mb-box2.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/motherboard/mother board 1/mb-box2.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
