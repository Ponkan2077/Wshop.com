...
<head>
    ...
    <title>ASUS Strix XG27ACS 27</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/laptop/laptop 2/41dZCf+77LL._SL500_-fotor-bg-remover-202404273209.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/laptop/laptop 2/41dZCf+77LL._SL500_-fotor-bg-remover-202404273209.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
