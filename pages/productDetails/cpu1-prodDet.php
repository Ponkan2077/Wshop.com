...
<head>
    ...
    <title>Intel Core i9-7900X CPU Processor</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/cpu/cpu 2/s-Intel-Core-X-Series-processor-family-21-690x460_2-fotor-bg-remover-2024042734440.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/cpu/cpu 2/s-Intel-Core-X-Series-processor-family-21-690x460_2-fotor-bg-remover-2024042734440.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
            ...
            <div class="productInfo">
                <h4>Intel Core i9-7900X CPU Processor</h4>
