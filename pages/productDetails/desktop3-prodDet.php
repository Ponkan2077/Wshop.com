        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/desktop/pc-gaming-computer-pc-cases-technology-wallpaper-preview.jpg" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/desktop/pc-gaming-computer-pc-cases-technology-wallpaper-preview.jpg"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
