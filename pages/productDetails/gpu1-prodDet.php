...
<head>
    ...
    <title>ROG GPU RtX 4090ti</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/gpu/nvidia-geforce-graphics-card-gpus-wallpaper-preview-fotor-bg-remover-2024042731432.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/gpu/nvidia-geforce-graphics-card-gpus-wallpaper-preview-fotor-bg-remover-2024042731432.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
