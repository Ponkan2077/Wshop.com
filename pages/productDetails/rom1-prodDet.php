...
<head>
    ...
    <title>Amiga Kickstart Flash ROM 27C400</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/rom/rom 1/rom8-fotor-bg-remover-2024042733156.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/rom/rom 1/rom8-fotor-bg-remover-2024042733156.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
            ...
            <div class="productInfo">
                <h4>Amiga Kickstart Flash ROM 27C400</h4>
