...
<head>
    ...
    <title>RS PRO 110 300V ac Input Stand Alone</title>
        ...
        <section id="productDetails" class="section-p1">
            <div class="image-slider">
                <div class="imageDisplayContainer">
                 <img src="/Wshop.com/assets/img/products/upc/UPS 1/UPS-10kVA-Online-UPS-Single-Phase-Computer-Power-Supply-UPS-for-PC-fotor-bg-remover-202404273366.png" width="100%" id="mainImg" alt="">
                </div>
                <div class="smallImageGroup">
                    <div class="smallImageCol">
                        <img src="/Wshop.com/assets/img/products/upc/UPS 1/UPS-10kVA-Online-UPS-Single-Phase-Computer-Power-Supply-UPS-for-PC-fotor-bg-remover-202404273366.png"  width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
            ...
            <div class="productInfo">
                <h4>RS PRO 110 300V ac Input Stand Alone</h4>
